      ...
      <nav className="navbar navbar-expand navbar-dark">
        ...
        {currentUser && currentUser.role === 'admin' && (
          ...
          <div className="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown" style = {{backgroundColor: '#77e6ad'}}>
                <a class="dropdown-item" href="/grant/sa2screen">Sa2Screen</a>   
                <li class="dropdown-submenu">
                <a class="dropdown-item" href="/grant/sa2screen">InCuBio</a>
                    <ul class="dropdown-menu" style = {{backgroundColor: '#77e6ad'}}>
        ...
        {currentUser && currentUser.role === 'scientist' && (
          <div className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              <Link to="/blastn" className="nav-link">
                <h5>Blastn</h5>
              </Link>
            </li>
          </div>
