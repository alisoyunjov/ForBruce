...
const File = (props) => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      const { grant, milestone, numberOfItems, fileCollection, orderStatus, receivedDate, dateR, price1, daysSinceRequest, price2, requestDay, submission, vendor1, vendor2, category, catalog1, catalog2, date, description,notes, msdFile} = state;
