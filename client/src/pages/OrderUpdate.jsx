...
const File = (props) => {
  ...
  const handleValidation = async =>{
    const {id, grant, milestone, fileCollection, orderStatus, receivedDate, price1, price2, submission, notes} = state
    let errors = {};
    let formIsValid = true;
    if (grant == 'InCuBio'){
      if (submission == '' || milestone == ''){
        formIsValid = false;
        errors["InCuBio"] = "Please enter Submission and Milestone";
  ...
  const Condition = ({ when, is, children }) => (
    <div name={when} subscription={{ value: true }}>
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      const {grant, id, milestone, fileCollection, orderStatus, receivedDate, price1, price2, submission, notes} = state
        ...
        <Col md={{ span: 8, offset: 2}}>
          ...
          <h1>Update Order</h1>
            <Form onSubmit={handleOnSubmit} >
              ...
              <Form.Group style = {{marginLeft: '50px', marginTop: '15px'}}>
              ...
              <Form.Row>
                ...
                <Form.Control 
                    ...
                    >
                    <option></option>
                    <option>InCuBio</option>
                    <option>Sa2Screen</option>
                   
                    </Form.Control>
                    <span style={{color: "red"}}>{state.errors["InCuBio"]}</span>
              </Form.Group>
              <Form.Group style = {{marginLeft: '20px'}}>
